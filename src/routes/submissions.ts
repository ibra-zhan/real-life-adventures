...
import { uploadSubmissionMedia, handleUploadError } from '../middleware/uploadMiddleware';
...
router.post('/', uploadLimiter, ...uploadSubmissionMedia, handleUploadError, submitQuestWithMedia);

// Get submission by ID
router.get('/:id', defaultLimiter, getSubmissionById);

// Update submission (metadata only, not media)
